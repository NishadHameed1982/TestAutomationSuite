...
public class TCA002_SRCreation_EmaarOne extends BaseTest {

	@Test (priority = 0 , description = "Test Case 002")
	public void TCA002_SRCreation(Method method) throws Throwable {


		SoftAssert softAssert = new SoftAssert();

		String testCase = "TCA002_SRCreation";
		Boolean finalTestStatus = true;

		report = extent.createTest("TCA002_SRCreation");
		report.info("TEST CASE: TCA002_SRCreation execution started");
		...
		for (int rowNum = 3;rowNum < 1000 ; rowNum++ )
		{
			...
			String testCaseDataSet = "TCA002_SRCreation -" + "Data Set " + (rowNum-2);
